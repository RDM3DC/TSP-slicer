...
arp = import_module("arp_adaptive_pi_sim")
...
def tour_hamming(a, b):
    # Hamming distance between tours up to rotation+reflection invariance is costly;
    # we use a simple edge-set symmetric difference as a proxy.
    def edges(ordr):
...
def run_experiment(args):
    ...
    # Initial curvature grid from default analytic field
    ...
    with out_csv.open("w", newline="") as f:
        ...
        for a in alphas:
            for m in mus:
                ...
                converged = int(max_flip == 0)  # crude
